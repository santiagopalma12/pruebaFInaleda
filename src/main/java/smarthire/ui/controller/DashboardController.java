...
public class DashboardController {
    ...
    private void onAgregarEmpleado() {
        ...
        try {
            ...
            formController.setEmpleado(new Empleado("", "", 0, 0, 0, ""), false);
    ...
    private void onEditarEmpleado() {
        ...
        if (seleccionado != null) {
            try {
                ...
                formController.setDashboardController(this);
                formController.setEmpleado(new Empleado(seleccionado), true);
    ...
    private void onEliminarEmpleado() {
        ...
        if (seleccionado != null) {
            ...
            smartHireController.eliminarEmpleado(seleccionado, true);
            recargarEmpleados();
        } else {
